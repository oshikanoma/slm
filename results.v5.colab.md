...
| Metric | Base | Tuned | Δ |
|---|---|---|---|
| **spec_pass_rate ↑** | **0.57% (1/175)** | **83.43% (146/175)** | **+82.86% ✅** |
| valid_output_rate ↑ | 72.00% (126/175) | 98.29% (172/175) | +26.29% ✅ |
| metadata_checks_rate ↑ | 95.43% (167/175) | 99.43% (174/175) | +4.00% ✅ |
| citation_validity_rate ↑ | 54.55% (12/22) | 91.18% (31/34) | +36.63% ✅ |
| fabricated_citation_rate ↓ | 45.45% (10/22) | 8.82% (3/34) | -36.63% ✅ |
| knowledge_leakage_rate ↓ | 2.99% (2/67) | 7.46% (5/67) | +4.48% ⚠️ |
| citation_precision ↑ | 18.18% (4/22) | 52.94% (18/34) | +34.76% ✅ |
| flag_recall ↑ | 9.35% (13/139) | 84.17% (117/139) | +74.82% ✅ |
| clean_no_op_rate ↑ | 91.67% (33/36) | 77.78% (28/36) | -13.89% ⚠️ |

### Statistical significance (spec_pass, base=control vs tuned=treatment)
- spec_pass delta (tuned - base): **+82.86%**, 95% bootstrap CI [+77.14%, +88.00%]
- McNemar exact p = **0.0000** (significant at alpha=0.05); tuned-only wins=145, base-only wins=0, discordant=145
...
| distractor | 81.25% (13/16) |
| misleading | 100.00% (12/12) |
| supported | 50.00% (18/36) |
| true_but_unsupported | 90.48% (19/21) |
...
- `{"id": "g_sup_007", "raw": "{\"clean\": false, \"verdicts\": [{\"type\": \"claim\", \"span\": \"Greg-Abbott-schools-property-tax-cut-election-2026/\", \"verdict\": \"supported\", \"source_url\": \"https://www.texastribune.org/2025/12/09/greg-abbott-schools-property-tax-cut-election-2026/\", \"eviden`
...
- `{"id": "g_sup_007", "span": "Greg-Abbott-schools-property-tax-cut-election-2026/", "source_url": "https://www.texastribune.org/2025/12/09/greg-abbott-schools-property-tax-cut-election-2026/", "evidence_span": "Greg-Abbott-schools-property-tax-cut-election-2026/"}`
